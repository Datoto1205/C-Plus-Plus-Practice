...
// 2. I could declare functions in the class, too.
// 3. I could divide the things in the class into two parts, which included the public part and the private part. The things in the former part could be called outside the class, but the things in the later part could not. This procedure is called encapsulation.
...
// 6. Inheritance was sometimes used by the sophisticated programmer, so this part was not involved in this file.
// 7. We could use constructor at the beginning of class to initialize variables in the class.
// 8. Tutorials I referred to: https://pydoing.blogspot.com/2012/10/cpp-class.html
